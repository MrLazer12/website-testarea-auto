...
<style>
    body {
        ...
        background: linear-gradient(0deg, rgba(6, 0, 101, 1) 0%, rgba(9, 9, 121, 1) 6%, rgba(137, 117, 198, 1) 100%);
    }
...
<body>
    ...
    <section class="center_content">
        <ul id="category_select">
            <li onclick="change_to_active(0)">
                <svg class="selected_category" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="car" class="svg-inline--fa fa-car fa-w-16" role="img" viewBox="0 0 512 512">
                ...
                <p type_category="autoturism">autoturism</p>
            </li>
            <li onclick="change_to_active(1)">
                ...
                <p type_category="motocicleta">motocicleta</p>
            </li>
            <li onclick="change_to_active(2)">
                ...
                <p type_category="autobuz">autobuz</p>
            </li>
            <li onclick="change_to_active(3)">
                ...
                <p type_category="camion">camion</p>
            </li>
            <li onclick="change_to_active(4)">
                ...
                <p type_category="remorca">remorca</p>
            </li>
            <li onclick="change_to_active(5)">
                ...
                <p type_category="semiremorca">semiremorca</p>
            </li>
            <li onclick="change_to_active(6)">
                ...
                <p type_category="tractor">tractor</p>
            </li>
        </ul>
        <br>
        ...
        <br>
        <article id="output">
            <p><b>Taxa pentru testarea tehnică:</b> <span id="testation_price">0</span></p>
            <p><b>Taxa pentru folosirea drumurilor:</b> <span id="price_roads">0</span></p>
        </article>
    </section>
    <br>
    <br>
    <section class="center_content prices">
        <table>
            <caption>NOILE TARIFE 2022 - pentru testarea tehnică obligatorie a vehiculelor</caption>
            <tr>
        ...
        <br>
        <table>
            <caption>Taxa pentru folosirea drumurilor de către autovehiculele înmatriculate în Republica Moldova 2022</caption>
            <thead>
                <tr>
                    <th>Nr.<br>crt.</th>
